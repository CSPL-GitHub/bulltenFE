...
export default function TestimonialsCard({
  ...
  return (
    <div className="group w-full min-h-64 relative bg-bullt-secondary rounded-md border-t-4 border-bullt-quaternary hover:rounded-md shadow-md mx-auto mt-12 mb-10  transition-colors duration-300">
      ...
      <div className="w-full h-full pt-14 px-4 pb-3 flex flex-col justify-between items-start gap-2 group-hover:bg-bullt-quaternary group-hover:rounded-md  transition-colors duration-300">
        ...
        <div className="flex flex-row gap-2 justify-center items-start">
          {testimonial?.testimonialsImageUrl ? (
            <div className="w-14 h-14 relative">
              <img
                src={testimonial?.testimonialsImageUrl}
                alt="Profile"
