    ...
    <>
      {DomainsearchApiResponse?.result?.Active === true ? (
        <section className="container mx-auto sm:flex sm:justify-center sm:items-center px-4 py-4 w-full  relative">
          ...
          <div className="flex flex-col gap-2 justify-center items-center sm:py-8 py-2 lg:max-w-5xl w-full mx-auto bg-bullt-secondary shadow-sm sm:px-6 px-2 sm:-mt-24 lg:-mt-32 rounded-md border-1 border-bullt-secondary">
