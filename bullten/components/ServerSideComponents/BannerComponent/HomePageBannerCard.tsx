  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-8 flex flex-col lg:flex-row items-center justify-between relative z-10">
        {banner?.image_url && (
          <div className="flex-1 flex sm:hidden w-full lg:justify-center mt-8 lg:mt-0 max-h-[200px] relative"
        ...
        <div className="flex flex-col sm:gap-7 gap-2 mt-5 sm:mt-0 items-start justify-center sm:w-[60%] w-full">
          {banner?.label ?
            <h2 className="text-white font-bold text-sm sm:text-xl mb-1 uppercase"> {banner?.label}</h2>
            : null}
          {banner?.title && (
          ...
          <div className="flex sm:flex-row flex-col gap-3 text-bullt-secondary">
            <div className="flex gap-2 items-center space-x-2">
              <Image
                ...
                height={30} />
              <div>
                <h3 className="text-xl font-semibold">{banner?.icon_1_header}</h3>
          ...
          <div className="flex gap-2 items-center space-x-2">
            <Image
              ...
              height={30} />
            <div>
              <h3 className="text-xl font-semibold">{banner?.icon_2_header}</h3>
              {/* <p dangerouslySetInnerHTML={{
      ...
      {banner?.image_url && (
        <div className="flex-1 hidden sm:flex lg:justify-center mt-8 lg:mt-0 h-[350px] relative"
          style={{ backgroundImage: `url('/blog-sub-card.png')` }}>
          <Image
            src={`${process.env.NEXT_PUBLIC_BASE_URL}${banner?.image_url}`}
            alt={banner?.alt_text || "Banner Image"}
