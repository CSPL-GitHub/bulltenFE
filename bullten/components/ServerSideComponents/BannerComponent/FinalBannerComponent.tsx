...
const FinalBannerComponent = ({ banner }: Props) => {
    ...
    return (
        <motion.div
            ...
            className="relative sm:max-h-[550px] min-h-[550px] max-h-[550px] overflow-hidden flex items-center justify-center "
            ...
            <div className="relative sm:flex items-center container min-h-[500px] z-20 sm:pt-0 pt-16 sm:pb-0 pb-10">
                ...
                <div className="flex-1 text-left lg:pl-20 lg:px-0 sm:px-5 px-4">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="text-xl text-bold border-2 border-bullt-text-quinary bg-bullt-text-quinary hover:bg-bullt-secondary text-bullt-secondary hover:text-bullt-tertiary rounded-md px-10 py-3 flex sm:mx-0 mx-auto"
                    >
