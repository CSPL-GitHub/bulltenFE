    ...
    <div className="w-full h-auto gap-8 lg:py-14 py-6 border-[1px] bg-white rounded-md">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 gap-6 justify-start items-start">
          <div>
            {ImageTextBoxesData?.heading || ImageTextBoxesData?.description ? (
              <div
                className={`flex gap-2 flex-col items-start justify-center `}
              >
        ...
        <div className="grid grid-cols-4 gap-4">
          {ImageTextBoxesData?.content.map((data: any, index: number) => {
            return (
              <div className="flex flex-col gap-1 rounded-lg border border-gray-50  bg-gray-50 p-3 shadow-solid-3 transition-all">
