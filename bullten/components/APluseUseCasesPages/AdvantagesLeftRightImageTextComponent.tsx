...
const AdvantagesLeftRightImageTextComponent = ({ AdvantagesData }: Props) => {
  return (
    <div className="bg-bullt-quaternary/[0.02] container mx-auto mt-6 py-4 lg:py-8 px-4 lg:px-0 space-y-8">
      <div className="max-w-7xl mx-auto ">
        ...
        {AdvantagesData?.content?.map((section: any, index: number) => (
          <div
            key={section.id}
            className={`w-full mx-auto flex flex-col md:flex-row items-center md:gap-10 gap-3 ${
...
export default AdvantagesLeftRightImageTextComponent;
