        ...
        <div className="py-6">
          <Slider {...settings}>
            {(activeTab === data.tab_one
              ...
              <div
                key={index}
                className="text-center hover:bg-blue-50 w-[140px] grayscale hover:grayscale-0 transition-all duration-100 ease-in-out py-2 rounded-md"
              >
                {item.img ? (
                  <div className="h-[70px] lg:w-[200px] w-[120px] relative mx-auto">
                    <Image
