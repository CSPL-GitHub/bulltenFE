        ...
        <div className="sm:px-4">
            <div className="border-b border-gray-200 mb-6">
                <nav className="flex justify-center gap-5">
                    <button
                        className={`relative text-lg font-medium py-2 px-4 rounded-md transition-all duration-200 ${activeTab === data.tab_one
                    ...
                    <button
                        className={`relative text-lg font-medium py-2 px-4 rounded-md transition-all duration-200 ${activeTab === data.tab_two
                                ? 'bg-blue-600 text-white shadow-md scale-105'
                                : 'bg-gray-100 text-black hover:bg-blue-50'
                            }`}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3  gap-5 py-3">
                    {(activeTab === data.tab_one ? data.operating_systems : data.list_titles)?.map((item: any, index: any) => (
                        <div key={index} className="bg-white border border-gray-200  sm:w-[160px] w-[160px] rounded-lg shadow-sm py-1 text-center hover:scale-105">
                            {item.img ? (
