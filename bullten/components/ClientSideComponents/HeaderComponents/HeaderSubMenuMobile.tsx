...
const HeaderSubMenuMobile = ({
  ...
  return (
    <div
      className={`${
        openSubMenu === menuKey || activeSubMenu ? "block" : "hidden"
      ...
      {headerMenu?.subheader?.map((subHeader: SubHeader, index: number) => {
        return (
          <div key={index}>
            ...
            >
              <h3 className="text-xl px-3 py-3 hover:bg-bullt-quaternary/[0.1] ">
                  ...
                  (subHeaderLinks: SubHeaderLinks) => (
                    ...
                    >
                      ...
                      <div className="col-span-5">
                        <p className="text-lg open">{subHeaderLinks?.title}</p>
                        <p className="text-xs">{subHeaderLinks?.description}</p>
                      </div>
                    </Link>
                  )
                )}
