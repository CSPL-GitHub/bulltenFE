                ...
                >
                    ...
                    <SliderFrame settings={settings} selector={undefined}>
                        {carouselData?.content?.map((item: any, index: number) => (
                            ...
                            >
                                <div className="mx-3 rounded-md  hover:scale-[1.01] transform transition-transform duration-300  before:transition-all before:duration-500  p-4 border-[1px] border-[#15151C]  shadow-lg">
                                    {item?.image ? <><div className="w-full h-[120px]  flex items-center">
                                        <img
                    ...
                    <div className="hidden sm:grid md:grid-cols-4 grid-cols-2 py-4">
                    {carouselData?.content?.map((item: any, index: number) => (
                            <div
                                key={index}
                                className="w-full h-auto flex flex-col item-center justify-center relative mb-4">
                                <div className="mx-3 rounded-md transform transition-transform duration-300 before:transition-all before:duration-500  p-4 border-[1px] border-[#15151C] hover:scale-105  shadow-lg">
                                    {item?.image ? <><div className="w-full h-[120px]  flex items-center">
                                        <img
                                            src={`${process.env.NEXT_PUBLIC_BASE_URL}${item?.image}`}
                                            alt={item?.heading}
