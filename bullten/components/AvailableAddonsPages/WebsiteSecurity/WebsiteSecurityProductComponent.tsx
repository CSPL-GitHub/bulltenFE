                      ...
                      >
                        <div className="flex flex-col justify-center items-center gap-2">
                          ...
                          <div className="flex gap-1 items-center">
                            <select
                              value={selectedPeriods[index] || "1 Year"} // Use the selected period for the specific plan
                              onChange={(e) => handlePeriodChange(e, index)} // Pass the plan index to handlePeriodChange
