      ...
      plan_periods: [
        {
          ...
          ssl_certificates: [
            ...
            },
            {
              feature: "Fix",
              prices: [
                { country: "usd", price: 29.99, plan: "1 Year" },
                { country: "eur", price: 27.99, plan: "1 Year" },
                { country: "inr", price: 2199, plan: "1 Year" },
              ],
              plan: "per year",
              button_text: "Buy Now",
...
const WebsiteSecurityProductsComponent = () => {
        ...
        {allPlans && (
          <div className="overflow-x-auto mt-10 lg:px-8">
            <table className="w-full border-collapse rounded-md">
                    ...
                    >
                      <div className="flex flex-col justify-center items-center gap-2">
                        ...
                        <div className="flex gap-1 items-center">
                          ...
                          >
                            <option value="1 Month">1 Year-₹2199</option>
                            <option value="1 Year">1 Year-₹2199</option>
                            <option value="2 Years">1 Year-₹2199</option>
                            <option value="3 Years">1 Year-₹2199</option>
                          </select>
                        </div>

                        {/* Display prices based on selected period */}
                        <div className="flex gap-1 items-center">
                          {plan?.prices
                            ?.filter(
                              (price: any) => price?.plan === selectedPeriod
                            )
              ...
              <tbody>
                {/* Render features and plan details */}
                {[
