            ...
            <div className="grid grid-cols-3 md:grid-cols-5 gap-6 h-full">
              {AlertAppData?.fav_data.map((app: any) => (
                <>
                  ...
                  >
                    {app.image && (
                      <div className="relative w-16 h-16 mb-4 bg-gradient-to-br from-bullt-quaternary/10 to-bullt-quaternary/40 rounded-2xl transform transition-transform duration-300 group-hover:rotate-6">
                        <Image
