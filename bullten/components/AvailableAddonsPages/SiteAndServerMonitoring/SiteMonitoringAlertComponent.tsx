...
export default function SiteMonitoringAlertComponent({ AlertAppData }: Props) {
  return (
    <div className="w-full  lg:py-16 py-6 bg-gray-50">
      <div className="p-0 max-w-7xl mx-auto overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-10 ">
          <div className="lg:col-span-3 bg-gradient-to-br from-bullt-quaternary/60 to-bullt-quaternary/20 p-8 rounded-lg flex flex-col justify-center">
            ...
            <p className="bg-white text-purple-600 hover:bg-gray-100 px-8 py-3 rounded-full text-lg font-semibold transition-all duration-300 shadow-md hover:shadow-lg w-full md:w-auto">
              Set Up Alerts
            </p>
          </div>
          <div className="lg:col-span-7 p-4 ">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 h-full">
              {AlertAppData?.fav_data.map((app: any) => (
                <>
                  ...
                  >
                    <div className="w-16 h-16 mb-4 bg-gradient-to-br from-bullt-tertiary/30 to-bullt-tertiary/80 rounded-2xl p-2  transform transition-transform duration-300 group-hover:rotate-6">
                      <img
