...
export default function SiteBuilderBannerComponent({ BannerData }: Props) {
  return (
    <section className="mx-auto w-full lg:h-[430px] h-[300px] bg-gradient-to-br from-bullt-tertiary/[0.07] via-white to-bullt-quaternary/[0.1] overflow-hidden">
