      ...
      <div className="bg-gradient-to-r from-purple-600 to-bullt-quaternary/70 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            {Data?.description ? (
              <p className="mt-6 max-w-3xl text-xl">{Data?.description}</p>
            ) : null}
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white shadow-xl rounded-lg overflow-hidden">
          <div className="p-6 sm:p-10">
            ...
            <section className="mb-12">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                {[
                  ...
                  >
                    <FaUserSecret className="text-bullt-quaternary mr-3" />
            ...
            {Data?.privacy_page_data.map((content: any, index: number) => {
              return (
                <section className="mb-12 " key={index}>
                  {content?.heading ? (
                    <h2 className="lg:text-3xl text-2xl font-bold text-gray-900 mb-6 flex items-center">
                      <FaLock className="mr-4 text-bullt-quaternary text-4xl" />
                      {content?.heading}
                    </h2>
                  ) : null}
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
              <FaUserFriends className="mr-4 text-bullt-quaternary text-4xl" />
              Data Sharing
            </h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
                <FaEnvelope className="mr-4 text-bullt-quaternary text-4xl" />
                Contact Us
              </h2>
              <div className="bg-bullt-quaternary text-white p-6 rounded-lg shadow-lg">
...
export default LegalPageAllComponent;
